...
def main():
    ...
    # Create model
    print("\nInitializing Autoregressive model...")
    model = AutoregressiveClassifier(window_size=window_size, input_dim=input_dim, ar_order=5)
    ...
    # Save model
    model_path = 'models/autoregressive_model.pth'
    ...
    results_df.to_csv('outputs/csv/autoregressive_results.csv', index=False)
    print("Results saved to outputs/csv/autoregressive_results.csv")
