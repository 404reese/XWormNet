...
def main():
    ...
    model = GRUClassifier(input_dim=input_dim, hidden_size=64)
    ...
    results_df.to_csv('outputs/csv/gru_results.csv', index=False)
    print("Results saved to outputs/csv/gru_results.csv")
